...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  <div class="bg-white shadow-lg rounded-xl w-full max-w-sm overflow-hidden p-6"> 
    ...
    <form id="paymentForm" method="POST" class="px-4 py-4 space-y-4"> 
      ...
      <button type="submit" class="w-full bg-purple-700 text-white font-semibold py-3 rounded-lg hover:bg-purple-500">Pay</button>
      <button type="button" onclick="document.getElementById('paymentForm').reset();" class="w-full bg-red-700 text-white font-semibold py-3 rounded-lg hover:bg-red-500">
        Cancel / Reset
      </button>
    </form>

    <div class="text-center mt-6">
      <a href="login.php" class="inline-block bg-blue-700 text-white font-semibold px-6 py-3 rounded-lg hover:bg-blue-500">
